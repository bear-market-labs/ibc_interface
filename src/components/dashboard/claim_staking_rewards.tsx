...
export default function ClaimStakingRewards(props: mintProps) {
  ...
  return (
    <>
      <Stack>
        ...
        <Text fontSize={'2xl'}>{`${Number(formatUnits(userClaimableStakingRewards, inverseTokenDecimals)).toFixed(4)} IBC`}</Text>
        {
          isProcessing &&
          <DefaultSpinner />
        }
